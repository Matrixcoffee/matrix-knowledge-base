...
@@html:<form action="http://matrix.org/federationtester/api/report">Server Domain:<input type="search" placeholder="matrix.org" name="server_name"><input type="submit" name="go" value="Test!" title="Show the federation test report for this server"></form>@@
